...
--
-- Name: bypass_saas_subscription(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.bypass_saas_subscription(p_plan_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION public.bypass_saas_subscription(p_plan_id uuid) OWNER TO postgres;
...
--
-- Name: sync_profiles_to_app_metadata(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.sync_profiles_to_app_metadata() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.sync_profiles_to_app_metadata() OWNER TO postgres;
...
--
-- Name: messages_2026_06_24; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_06_24 OWNER TO supabase_admin;

--
-- Name: messages_2026_06_25; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_06_25 OWNER TO supabase_admin;
...
--
-- Name: messages_2026_06_24; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_25; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_24 messages_2026_06_24_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_25 messages_2026_06_25_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_24_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_25_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_06_24_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_06_24_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_06_25_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_06_25_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: profiles trg_sync_profiles_to_app_metadata; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_sync_profiles_to_app_metadata AFTER INSERT OR UPDATE OF role, institution_id, is_active ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.sync_profiles_to_app_metadata();
...
--
-- Name: institutions Permitir lectura publica de instituciones activas; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Permitir lectura publica de instituciones activas" ON public.institutions FOR SELECT USING ((is_active = true));
...
CREATE POLICY reservations_delete ON public.reservations FOR DELETE TO authenticated USING (((user_id = auth.uid()) OR ((EXISTS ( SELECT 1
   FROM public.class_sessions cs
  WHERE ((cs.id = reservations.session_id) AND (cs.institution_id = public.kali_institution_id())))) AND public.kali_is_admin())));
...
CREATE POLICY reservations_insert ON public.reservations FOR INSERT TO authenticated WITH CHECK ((((user_id = auth.uid()) AND (EXISTS ( SELECT 1
   FROM public.class_sessions cs
  WHERE ((cs.id = reservations.session_id) AND (cs.institution_id = public.kali_institution_id()))))) OR ((EXISTS ( SELECT 1
   FROM public.class_sessions cs
  WHERE ((cs.id = reservations.session_id) AND (cs.institution_id = public.kali_institution_id())))) AND public.kali_is_admin())));
...
CREATE POLICY reservations_select ON public.reservations FOR SELECT TO authenticated USING (((user_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.class_sessions cs
...
CREATE POLICY reservations_update ON public.reservations FOR UPDATE TO authenticated USING (((user_id = auth.uid()) OR ((EXISTS ( SELECT 1
   FROM public.class_sessions cs
  WHERE ((cs.id = reservations.session_id) AND (cs.institution_id = public.kali_institution_id())))) AND public.kali_is_admin()))) WITH CHECK (((user_id = auth.uid()) OR ((EXISTS ( SELECT 1
   FROM public.class_sessions cs
  WHERE ((cs.id = reservations.session_id) AND (cs.institution_id = public.kali_institution_id())))) AND public.kali_is_admin())));
...
CREATE POLICY subscriptions_delete ON public.subscriptions FOR DELETE TO authenticated USING (((EXISTS ( SELECT 1
   FROM public.plans p
  WHERE ((p.id = subscriptions.plan_id) AND (p.institution_id = public.kali_institution_id())))) AND public.kali_is_admin()));
...
CREATE POLICY subscriptions_insert ON public.subscriptions FOR INSERT TO authenticated WITH CHECK (((EXISTS ( SELECT 1
   FROM public.plans p
  WHERE ((p.id = subscriptions.plan_id) AND (p.institution_id = public.kali_institution_id())))) AND public.kali_is_admin()));
...
CREATE POLICY subscriptions_update ON public.subscriptions FOR UPDATE TO authenticated USING (((EXISTS ( SELECT 1
   FROM public.plans p
  WHERE ((p.id = subscriptions.plan_id) AND (p.institution_id = public.kali_institution_id())))) AND public.kali_is_admin())) WITH CHECK (((EXISTS ( SELECT 1
   FROM public.plans p
  WHERE ((p.id = subscriptions.plan_id) AND (p.institution_id = public.kali_institution_id())))) AND public.kali_is_admin()));
...
--
-- Name: objects Authenticated users can upload logos 1peuqw_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Authenticated users can upload logos 1peuqw_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'logos'::text));
...
--
-- Name: supabase_realtime tenant_subscriptions; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.tenant_subscriptions;
...
--
-- Name: FUNCTION bypass_saas_subscription(p_plan_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.bypass_saas_subscription(p_plan_id uuid) TO anon;
GRANT ALL ON FUNCTION public.bypass_saas_subscription(p_plan_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.bypass_saas_subscription(p_plan_id uuid) TO service_role;
...
--
-- Name: FUNCTION sync_profiles_to_app_metadata(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.sync_profiles_to_app_metadata() TO anon;
GRANT ALL ON FUNCTION public.sync_profiles_to_app_metadata() TO authenticated;
GRANT ALL ON FUNCTION public.sync_profiles_to_app_metadata() TO service_role;
...
--
-- Name: TABLE messages_2026_06_24; Type: ACL; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: TABLE messages_2026_06_25; Type: ACL; Schema: realtime; Owner: supabase_admin
--
