...
if [ -z "$1" ] || [ -z "$2" ]; then
  echo "================================================================"
  echo "Uso: ./activar_pago.sh <email_del_usuario> <fecha_vencimiento>"
  echo "Ejemplo: ./activar_pago.sh usuario@gmail.com \"2027-01-01\""
  echo "================================================================"
  exit 1
fi
...
BEGIN
    ...
    -- 2. Obtener un plan para asignar en caso de inserción (el primero activo)
