...
class _CreateTemplateDialogState extends State<CreateTemplateDialog> {
  ...
  Future<void> _submit() async {
    ...
    final payload = _selectedDays.map((day) => {
      ...
      'day_of_week': day, // Supabase enum day_of_week (lowercase)
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Plantillas creadas exitosamente')),
        );
      }
    } catch (e) {
      setState(() {
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Nueva Plantilla de Clase',
                  style: KaliText.heading(KaliColors.espresso, size: 24),
                ),
                const SizedBox(height: 8),
                Text(
                  'Crea esquemas reutilizables para agendar turnos fácilmente.',
